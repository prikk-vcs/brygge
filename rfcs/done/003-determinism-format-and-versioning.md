...
**Status.** **Implemented (0.1.0, 2026-09-24)**; shipped in brygge 0.1.0, and kept in `done/` as the historical record. History: Accepted (2026-09-04). Resolves RFC 001's three open questions (OQ-A codec, OQ-B snapshot vs
